          ...
          if (operationController.selectedContainer != null) {
            ...
            return Visibility(
              ...
              child: Container(
                ...
                height: 250.h,
                width: MediaQuery.of(context).size.width - 20.w,
                child: StreamBuilder<ContainerModel>(
                    stream: operationController.getContainerInformation(),
                      ...
                      if (snapshot.hasData) {
                        ...
                        return Column(
                          ...
                          children: [
                            ...
                            Text(
                              "Sensor ID: ${container.sensorId}",
                              style: AppTextStyles.t1,
                            ),
                            Text(
                              "Container Temperature: ${container.containerTemperature.toStringAsFixed(2)}",
                              style: AppTextStyles.t1,
                            ),
                            Text(
                              "Sensor data date: ${container.dateOfDataReceived.formattedDate}",
                              style: AppTextStyles.t1,
                            ),
                            Text(
                              "Fullness Rate",
                            ...
                            Text(
                              "% ${container.occupancyRate.toStringAsFixed(2)}",
                              style: AppTextStyles.t1,
                            ),
