...
class OperationController extends GetxController {
  ...
  final OperationService _operationService = serviceLocator<OperationService>();

  Future<void> getNearbyContainers(BuildContext context) async {
    final result = await _operationService.getNearbyContainers(bounds);
  ...
  Future<void> relocateContainer(BuildContext context) async {
    final result = await _operationService.relocateContainer(relocatedContainer!);
